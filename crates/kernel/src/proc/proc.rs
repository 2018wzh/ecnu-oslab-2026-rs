...
pub struct Proc {
    ...
    pub pgtbl: usize,
    #[allow(missing_docs)] pub heap_top: usize,
    #[allow(missing_docs)] pub ustack_npage: usize,
    #[allow(missing_docs)] pub mmap_base: usize,
}
...
/// # Safety
/// 必须在当前进程的上下文里调用。
pub unsafe fn proc_copy(parent_pid: usize) -> Option<usize> { unimplemented!() }
